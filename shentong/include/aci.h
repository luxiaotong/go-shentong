...
#define ACI_HTYPE_LAST          31            /* last value of a handle type */
...
#define ACI_DTYPE_LAST          79        /* last value of a descriptor type */
...
#define ACI_SESSGET_CPOOL      ACI_CPOOL  /* SessionGet called in CPOOL mode */
...
/*----------------------- Execution Modes -----------------------------------*/
#define ACI_BATCH_MODE        0x01  /* batch the aci statement for execution */
#define ACI_EXACT_FETCH       0x02         /* fetch the exact rows specified */
/* #define                    0x04                                 available */
#define ACI_STMT_SCROLLABLE_READONLY 0x08     /* if result set is scrollable */
#define ACI_DESCRIBE_ONLY     0x10            /* only describe the statement */
#define ACI_COMMIT_ON_SUCCESS 0x20        /* commit, if successful execution */
#define ACI_NON_BLOCKING      0x40                           /* non-blocking */
#define ACI_BATCH_ERRORS      0x80             /* batch errors in array dmls */
#define ACI_PARSE_ONLY        0x100              /* only parse the statement */
#define ACI_EXACT_FETCH_RESERVED_1 0x200                         /* reserved */
#define ACI_SHOW_DML_WARNINGS 0x400   
         /* return ACI_SUCCESS_WITH_INFO for delete/update w/no where clause */
#define ACI_EXEC_RESERVED_2   0x800                              /* reserved */
#define ACI_DESC_RESERVED_1   0x1000                             /* reserved */
#define ACI_EXEC_RESERVED_3   0x2000                             /* reserved */
#define ACI_EXEC_RESERVED_4   0x4000                             /* reserved */
#define ACI_EXEC_RESERVED_5   0x8000                             /* reserved */
...
#define ACI_ATTR_SOCKET_TIMEOUT			   1009
...
typedef struct ACISPool         ACISPool;             /* session pool handle */
